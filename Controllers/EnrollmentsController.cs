...
namespace Asp_Labb2.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.GradeList = new SelectList(Enum.GetValues(typeof(Grade)));
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,Grade,FkCourseId,FkStudentId,FkTeacherId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,Grade,FkCourseId,FkStudentId, FkTeacherId")] Enrollment enrollment)
        {
